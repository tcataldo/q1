 ...
 *   Q1_PEERS        comma-separated peer list     (default: none → standalone)
 *                   format: id:host:httpPort:raftPort per entry
 *   Q1_RAFT_PORT    Raft RPC port                 (default: 6000)
...
public final class Q1Server implements Closeable {
    ...
    /** Cluster constructor (plain Raft replication). */
    public Q1Server(StorageEngine engine, RatisCluster cluster,
                    PartitionRouter partitionRouter, int port) {
        this.engine        = engine;
    ...
    /**
     * Parse {@code Q1_PEERS} value: comma-separated list of
     * {@code id:host:httpPort:raftPort}.
     */
    static List<NodeId> parsePeers(String raw) {
